      ...
      >
        <div className="bg-[#09090b]/80 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl border border-zinc-800 p-10">
          ...
          <div className="relative my-8 text-center">
            <span className="px-4 bg-[#09090b]/80 relative z-10 text-zinc-500 text-xs font-bold uppercase tracking-widest">Or continue with</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 py-3 bg-zinc-900/50 border border-zinc-800 rounded-2xl text-zinc-100 font-bold hover:bg-zinc-800 transition-all">
