    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-chat-bg-primary/90 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] border border-white/10 w-full max-w-5xl h-[90vh] md:h-[85vh] overflow-hidden flex flex-col"
        >
          {/* Header */}
